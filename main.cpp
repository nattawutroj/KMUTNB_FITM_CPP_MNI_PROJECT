...
void member_list_show()
{
    cout << "=" << setw(size2) << "MEMBER PHONE" << setw(size2) << "=" << setw(size3) << "MEMBER NAME" << setw(size3) << "=" << setw(size5) << "E-MAIL" << setw(size5) << "=" << setw(size4) << "Province" << setw(size4) << "=" << endl;
}
void header_add_item()
{
...
void Displays(int show)
{
    ...
    else if (show == 3)
    {
        ...
        string name;
        cin >> name;
        cout << setw(size6) << "E-Mail : ";
        string email;
        cin >> email;
        cout << setw(size6) << "Phone : ";
        string phone;
        cin >> phone;
        cout << setw(size6) << "Province : ";
        string province;
        cin >> province;
        ...
        if (confirm == "Y" || confirm == "y")
        {
            ...
            cout << setw(size7) << "E-Mail : " << member[loop][2] << endl;
            cout << setw(size7) << "Province : " << member[loop][3] << endl;
            border();
    ...
    else if (show == 5)
    {
        ...
        while (member[loop_member][0] != dummy)
        {
            ...
            component[loop_member][3] = member[loop_member][3];
            loop_member++;
        }
...
void Sell()
{
    ...
    else if (command == "h" || command == "H" || command == ".history")
    {
        reset_component();
        Displays(6);
    }
